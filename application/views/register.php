    ...
    <div class="register-box-body">
        <p class="login-box-msg">注册</p>
            ...
            <div class="form-group has-feedback">
                <input id="name" class="form-control" placeholder="用户名" type="text">
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input id="email" class="form-control" placeholder="邮箱" type="text">
            ...
            <div class="form-group has-feedback">
                <input id="repasswd" class="form-control" placeholder="重复密码" type="password">
                <span class="glyphicon glyphicon-log-in form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input id="code" class="form-control" placeholder="邀请码" type="text">
        ...
        <a href="../index.php/login" class="text-center">已经注册？请登录</a>
    </div><!-- /.form-box -->
</div><!-- /.register-box -->
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data.ok){
                        ...
                        window.setTimeout("location.href='../../index.php/login'", 2000);
                    }else{
                        $("#msg-error").hide(10);
                        $("#msg-error").show(100);
