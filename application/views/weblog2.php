...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="index.html" class="logo">Mshield</a>
    ...
    <div style="min-height: 780px;" class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="box box-solid">
                        <?php if(!$website){echo('<div class="box-header"><h3 class="box-title">绑定网站</h3><br><p>暂无绑定网站</p><hr><button id="addwebsite" class="btn btn-primary" data-toggle="modal" data-target="#myModal">添加网站</button></div>');}else{?>
                        <?php foreach($website as $web){ ?>
                        <div class="box-header">
                            <h3 class="box-title">绑定网站</h3><br>
                            <p style="display:inline-block"><?=$web->url ?>&nbsp;</p><p style="display:inline-block;color:<?php if($web->ischeck==0) {echo "grey\">[等待验证]";} elseif($web->ischeck==1) {echo "green\">[验证通过]";} else{echo "red\">[未通过验证]";}  ?></p>
                        <hr><button id="addwebsite" class="btn btn-primary" data-toggle="modal" data-target="#myModal">添加网站</button>
                        </div><!-- /.box-header -->
                        <?php }} ?>
                        <div class="box-body">
                        </div><!-- /.box-body -->
