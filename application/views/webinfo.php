                ...
                <div class="col-md-12">
                    <div class="box box-solid">
                        <div class="box-header">
                            <strong><h3>基本信息管理</h3></strong>
                            <p>网站标题前缀</p>
                            <input class="form-control" value="<?=$title?>"/>
                            <p>网站首页标题</p>
                            <input class="form-control" value="<?=$index?>"/>
                            <p>网站公告</p>
                            <textarea class="form-control" rows="3"><?=$notice?></textarea>
                            <hr>
                            <button id="infosub" class="btn btn-primary">保存信息</button>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                        </div><!-- /.box-body -->
                    </div><!-- /.box -->
