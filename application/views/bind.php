...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="http://ss.inory.org/user/index.php" class="logo">Mshield</a>
                        ...
                        <!-- form start -->
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="网站域名(必填)" id="domain" type="text">
                                </div>

                                <div class="form-group">
                                    <input class="form-control" placeholder="服务器ip(必填)" id="pwd" type="password">
                                </div>

                                <div class="form-group">
                                    <input placeholder="域名服务器地址(可不填)" class="form-control" id="repwd" type="password">
                                </div>

                            </div><!-- /.box-body -->

                            <div class="box-footer">
                                <button type="submit" id="pwd-update" class="btn btn-primary">绑定</button>
                            </div>
